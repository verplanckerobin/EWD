...
@Entity
@NamedQueries({ @NamedQuery(name = "Bier.findByName", query = "select b from Bier b where b.naam = :bierNaam") })
public class Bier implements Serializable {
	...
	return "Bier{" + "bierID=" + bierID + ", naam=" + naam + ", soort=" + soort + ", brouwerij=" + brouwerij
		+ ", alcoholgehalte=" + alcoholgehalte + ", beoordeling=" + beoordeling + '}';
    }
	...
	hash = 29 * hash + (int) (Double.doubleToLongBits(this.alcoholgehalte)
		^ (Double.doubleToLongBits(this.alcoholgehalte) >>> 32));
	hash = 29 * hash + (int) (Double.doubleToLongBits(this.beoordeling)
		^ (Double.doubleToLongBits(this.beoordeling) >>> 32));
	return hash;
    }
